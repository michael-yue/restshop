  ...
  <div class="cardlist">
    ...
    <div :style="{height: myHeight}" style="padding:0 20px 10px 20px;">
      <el-table
        ...
        <el-table-column prop="userFee" label="餐费金额" header-align="center" align="left" />
        <el-table-column
          fixed="right"
          label="操作"
          width="100">
...
<script>
import { listAllUserType, addUserType, updateUserType, deleteUserType } from '@/api/branch.js'
